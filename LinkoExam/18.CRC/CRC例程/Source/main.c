...
{
    Hardware_init(); /* 硬件初始化 */
    crc8_answer = crc8(crc_data, sizeof(crc_data));
	crc16_MODBUS_answer = crc16_MODBUS(crc_data, sizeof(crc_data));
	crc32_answer = crc32(crc_data, sizeof(crc_data));
