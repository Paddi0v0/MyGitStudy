...
void ADC0_IRQHandler(void)
{
    ...
    struFOC_CurrLoop.nBusVoltage = GET_BUS_VOL_ADC_RESULT; /* 母线电压采样 */ //1000

	  struAppCommData.nVspADC = (s16)ADC0_DAT5; /*电位器信号采样结果*/
	
	struBemfVolt.nPhaseU = (s16)ADC0_DAT7;
...
//			  Rttstru.data2 = (struHallProcess.nElectrical_Angle);        //HALL角度
			
//			  Rttstru.data2 = (stru_BEMF_Check.unBemf_Angle);             //反电动势角度
			  Rttstru.data2 = (struFOC_CurrLoop.mStatCurrUVW.nPhaseU);    //U相电流角度
//			  Rttstru.data1 = (struFOC_CurrLoop.mStatCurrUVW.nPhaseV);    //V相电流角度
//        Rttstru.data2 = (struFOC_CurrLoop.mStatCurrUVW.nPhaseW);    //W相电流角度
		
 //       Rttstru.data0 = (struBemfVolt.nPhaseU);            //U相反电动势电压
//		  Rttstru.data1 = (struBemfVolt.nPhaseV);            //V相反电动势电压
 //      Rttstru.data2 = (struBemfVolt.nPhaseW);            //W相反电动势电压
