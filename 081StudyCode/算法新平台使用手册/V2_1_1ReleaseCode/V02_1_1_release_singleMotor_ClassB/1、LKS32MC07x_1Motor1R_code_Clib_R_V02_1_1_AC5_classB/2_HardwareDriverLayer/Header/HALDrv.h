...
static inline void HAL_DRV1_MCPWM_RegUpdate(STR_PubDatMDHD* tS_pMdToHd)
{
    MCPWM_TH30 = tS_pMdToHd->mMcPwm.nuTimePhBN;
    MCPWM_TH31 = tS_pMdToHd->mMcPwm.nuTimePhB;
    
    MCPWM_TH40 = tS_pMdToHd->mMcPwm.nuTimePhAN;
    MCPWM_TH41 = tS_pMdToHd->mMcPwm.nuTimePhA;

    MCPWM_TH50 = tS_pMdToHd->mMcPwm.nuTimePhCN;
    MCPWM_TH51 = tS_pMdToHd->mMcPwm.nuTimePhC;

    MCPWM_TMR2 = tS_pMdToHd->mMcTmr.nuPoint0;	// 第一个采样点
    MCPWM_TMR3 = tS_pMdToHd->mMcTmr.nuPoint1;	// 第二个采样点	
}
