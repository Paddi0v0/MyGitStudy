...
void MCPWM_Init(MCPWM_REG_TypeDef *MCPWMx, MCPWM_InitTypeDef *MCPWM_InitStruct)
{
    ...
    MCPWMx->PWM_TCLK = MCPWM_InitStruct->CLK_DIV | (MCPWM_InitStruct->MCLK_EN << 2) | (MCPWM_InitStruct->TMR2_TimeBase_Sel << 4) | (MCPWM_InitStruct->TMR3_TimeBase_Sel << 5) | (MCPWM_InitStruct->MCPWM_Cnt0_EN << 6) | (MCPWM_InitStruct->MCPWM_Cnt1_EN << 7) | (MCPWM_InitStruct->TimeBase0_Trig_Enable << 8) | (MCPWM_InitStruct->TimeBase1_Trig_Enable << 9);
