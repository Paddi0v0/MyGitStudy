...
s16 getBemf_U(u8 t_bObjId)   //获取iqRef电流值
{
	return (s16)(gS_PhyObjInstanceM[t_bObjId].mGlobalDatPackage.mHdToMd.nBmefUVolAdcDat);
}
 s16 getBemf_V(u8 t_bObjId)   //获取idRef电流值
{
	 return (s16)(gS_PhyObjInstanceM[t_bObjId].mGlobalDatPackage.mHdToMd.nBmefVVolAdcDat);
}
#endif
...
s16 getFOCElecAnle(u8 t_bObjId)   //获取foc电角度
{
	return (s16)(gS_FocElementObjM[t_bObjId].mMotorAngle.wElectAngle);
}
