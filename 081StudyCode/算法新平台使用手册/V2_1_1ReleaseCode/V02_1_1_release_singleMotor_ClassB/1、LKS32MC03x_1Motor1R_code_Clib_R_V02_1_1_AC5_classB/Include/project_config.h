...
/*********************************************************************************/
#define MCU_MCLK_USED                   (MCU_MCLK_48M)		// 当前MCU主频
...
#define DRV0_BEMF_CHECK_EABLE			(FUNCTION_OFF)				//	检查反电势采样通道数目和配置
...
#define CLASSB_ENABLE						(FUNCTION_OFF)    	/* 是否使能CLASSB功能 FUNCTION_ON：使能;  FUNCTION_OFF：不使能;*/
...
//		__attribute__((section(".ARM.__at_0x7E00")))
// sizeof(STR_DrvCfgGlobal) = 8
// IN different MCU, the address is different

#define ADDR_DOWNLOAD_WRITE_LOCATION	(0x20000FFE)
#define ADDR_DOWNLOAD_READ_LOCATION		(0x20000FFF)

#define ADDR_PARA_LOCATION				(0x7E00)
