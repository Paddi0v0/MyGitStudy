...
#define ADC0_MCU_TEMP_CHANNEL			(ADC_CHANNEL_18)	/* TEMP 检测 CH18*/
#define ADC0_UVSS_VOLT_CHANNEL			(ADC_CHANNEL_19)	/* VSS  检测 CH19*/
...
#define GET_MCU_TEMP						(ADC0_DAT10)
#define GET_UVSS_VOLT						(ADC0_DAT11)
