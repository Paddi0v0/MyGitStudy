...
// In Keil V6 compiler, as _at_ is changed, the address is directly used in 
//		__attribute__((section(".ARM.__at_0x7E00")))
// sizeof(STR_DrvCfgGlobal) = 8
// IN different MCU, the address is different

#define ADDR_DOWNLOAD_WRITE_LOCATION	(0x20000000)
#define ADDR_DOWNLOAD_READ_LOCATION		(0x20000004)
