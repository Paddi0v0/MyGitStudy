...
volatile u8 gs_bDownReqCmd		__attribute__((section(".ARM.__at_0x20000000"))) = 0;
volatile u8 gs_bDownAckStatus	__attribute__((section(".ARM.__at_0x20000004"))) = 0;
...
const STR_DrvCfgPara 		tS_DrvCfgPara[MAX_CFG_PARA_ID] __attribute__((section(".ARM.__at_0x7E08"))) = {
