...
void UTIMER_Init(UTIMER_TypeDef *TIMERx, UTIMER_InitTypeDef *this)
{
    ...
    if ((TIMERx == UTIMER0)||(TIMERx == UTIMER1)||(TIMERx == UTIMER2) )
    {
        TIMERx->CFG = (u32)(this->EN << 31) | (u32)(this->CAP1_CLR_EN << 27) | (u32)(this->CAP0_CLR_EN << 26) | (u32)(this->ONE_TRIG << 25) | (u32)(this->ETON << 24) |
                  (u32)(this->CLK_DIV << 20) | (u32)(this->CLK_SRC << 16) | (u32)(this->SRC1 << 12) | (u32)(this->CH1_POL << 11) |
                  (u32)(this->CH1_MODE << 10) | (u32)(this->CH1_FE_CAP_EN << 9) | (u32)(this->CH1_RE_CAP_EN << 8) | (u32)(this->SRC0 << 4) |
                  (u32)(this->CH0_POL << 3) | (u32)(this->CH0_MODE << 2) | (u32)(this->CH0_FE_CAP_EN << 1) | (u32)(this->CH0_RE_CAP_EN << 0);
    }
    if (TIMERx == UTIMER3)
    {
        TIMERx->CFG = (u32)(this->EN << 31) | (u32)(this->CAP1_CLR_EN << 25) | (u32)(this->CAP0_CLR_EN << 24) | (u32)(this->ONE_TRIG << 23) | (u32)(this->ETON << 22) |
                  (u32)(this->CLK_SRC << 18)|(u32)(this->CLK_DIV << 16)  | (u32)(this->SRC1 << 12) | (u32)(this->CH1_POL << 11) |
                  (u32)(this->CH1_MODE << 10) | (u32)(this->CH1_FE_CAP_EN << 9) | (u32)(this->CH1_RE_CAP_EN << 8) | (u32)(this->SRC0 << 4) |
                  (u32)(this->CH0_POL << 3) | (u32)(this->CH0_MODE << 2) | (u32)(this->CH0_FE_CAP_EN << 1) | (u32)(this->CH0_RE_CAP_EN << 0);
    }
    if (TIMERx == UTIMER4)
    {
        TIMERx->CFG = (u32)(this->EN << 31) | (u32)(this->CAP1_CLR_EN << 25) | (u32)(this->CAP0_CLR_EN << 24) | (u32)(this->ONE_TRIG << 23) |(u32)(this->ETON << 22) |
                  (u32)(this->CLK_DIV << 20)|(u32)(this->CLK_SRC << 16)| (u32)(this->SRC1 << 12) | (u32)(this->CH1_POL << 11) |
                  (u32)(this->CH1_MODE << 10) | (u32)(this->CH1_FE_CAP_EN << 9) | (u32)(this->CH1_RE_CAP_EN << 8) | (u32)(this->SRC0 << 4) |
                  (u32)(this->CH0_MODE << 3) | (u32)(this-> CH0_POL<< 2) | (u32)(this->CH0_FE_CAP_EN << 1) | (u32)(this->CH0_RE_CAP_EN << 0);
    }
    TIMERx->TH = this->TH;
    ...
    TIMERx->FLT = this->FLT;
    TIMERx->IE = this->IE | (u32)(this->RE << 8);
