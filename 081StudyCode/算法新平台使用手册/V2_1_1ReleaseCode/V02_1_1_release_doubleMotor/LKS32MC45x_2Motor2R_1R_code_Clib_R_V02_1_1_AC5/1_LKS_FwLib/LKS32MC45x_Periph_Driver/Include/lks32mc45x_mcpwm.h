...
typedef struct
{
    ...
    u8 MCPWM_UpdateInterval;   ///< MCPWM T0/T1事件更新间隔
    u8 MCPWM_Base0T0_UpdateEN; ///< MCPWM T0/T1事件更新间隔
    u8 MCPWM_Base0T1_UpdateEN; ///< MCPWM T0/T1事件更新间隔
    u8 MCPWM_Base1T0_UpdateEN; ///< MCPWM T0/T1事件更新间隔
    u8 MCPWM_Base1T1_UpdateEN; ///< MCPWM T0/T1事件更新间隔
    u8 MCPWM_Auto_ERR_EN;      ///< MCPWM T0/T1事件更新间隔
