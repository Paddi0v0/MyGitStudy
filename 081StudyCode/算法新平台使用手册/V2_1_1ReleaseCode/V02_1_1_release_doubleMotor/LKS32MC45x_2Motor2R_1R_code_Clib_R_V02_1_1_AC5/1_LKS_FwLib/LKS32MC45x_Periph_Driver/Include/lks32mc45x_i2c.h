...
typedef struct
{
    __IO u32 ADDR; ///< I2C地址寄存器
    __IO u32 CFG;  ///< I2C配置寄存器
    __IO u32 SCR;  ///< I2C状态寄存器
    __IO u32 DATA; ///< I2C数据寄存器
    __IO u32 MSCR; ///< I2C主模式寄存器
    __IO u32 BCR;  ///< I2C传输控制寄存器
} I2C_TypeDef;
...
void I2C_Init(I2C_TypeDef *I2Cx, I2C_InitTypeDef *this); ///< I2C初始化
