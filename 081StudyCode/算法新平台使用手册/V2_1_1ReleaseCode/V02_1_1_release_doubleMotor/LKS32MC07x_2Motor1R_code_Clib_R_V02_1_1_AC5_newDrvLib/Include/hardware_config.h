...
#define  CNT1_PRE_DRIVER_POLARITY      P_HIGH__N_HIGH     /* 预驱预动极性设置 上管高电平有效，下管高电平有效 */
...
#define ADC0_1SHUNT_CURR_CH             (ADC0_CHANNEL_OPA3)  /* 单电阻采样电流通道 */


#define BEMF_CH_A_M0					ADC_CHANNEL_13       /* A相反电势检测ADC通道号 */
#define BEMF_CH_B_M0					ADC_CHANNEL_12       /* B相反电势检测ADC通道号 */
#define BEMF_CH_C_M0					ADC_CHANNEL_11       /* C相反电势检测ADC通道号 */

/* --------------------------------M1------------------------------ */
#define ADC1_CURRETN_A_CHANNEL         (ADC1_CHANNEL_OPA3)
#define ADC1_CURRETN_B_CHANNEL         (ADC1_CHANNEL_OPA2)
#define ADC1_CURRETN_C_CHANNEL         (ADC1_CHANNEL_OPA0)


#define ADC1_1SHUNT_CURR_CH            (ADC1_CHANNEL_OPA3)		/* 单电阻采样电流通道 */

#define BEMF_CH_A_M1					ADC_CHANNEL_13       /* A相反电势检测ADC通道号 */
#define BEMF_CH_B_M1					ADC_CHANNEL_12       /* B相反电势检测ADC通道号 */
#define BEMF_CH_C_M1					ADC_CHANNEL_11       /* C相反电势检测ADC通道号 */
...
//M0 第一个采样数据，第二个采样数据
#define GET_ADC0_DATA_M1					(ADC1_DAT0)   
#define GET_ADC1_DATA_M1					(ADC1_DAT2)
#else
#define GET_ADC0_DATA_M1					(ADC1_DAT0)
#define GET_ADC1_DATA_M1					(ADC1_DAT1)
#endif
...
#define GET_M1_BUS_VOL_ADC_RESULT			(ADC1_DAT4)
#define GET_M1_TEMP_DATA_A					(ADC1_DAT6)
#define GET_M1_BEMF_DATA_A					(ADC1_DAT8)
#define GET_M1_BEMF_DATA_B					(ADC1_DAT9)
#define GET_M1_BEMF_DATA_C					(ADC1_DAT10)
...
#define ADC_SOFTWARE_TRIG_ONLY()		{ADC0_TRIG = 0;ADC1_TRIG = 0;}      /* ADC设置为仅软件触发 */
