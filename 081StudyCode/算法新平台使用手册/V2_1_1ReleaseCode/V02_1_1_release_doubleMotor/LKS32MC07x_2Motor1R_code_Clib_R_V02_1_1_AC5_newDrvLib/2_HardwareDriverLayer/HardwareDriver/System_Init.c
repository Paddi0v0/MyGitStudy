...
static void CurrentOffsetReadPWM0(STR_PubDatHDMD* tS_pHdToMd, u16 t_nuCalPeriod)
{
    ...
    EPWM0_OutPut(DISABLE); //对于非MOS内阻采样，可使能也可不使能
    ...
    //单电阻Offset
		...
		ADC_CHN_GAIN_CFG(ADC0, CHN0, ADC0_1SHUNT_CURR_CH, ADC_GAIN3V6);
	    ADC_CHN_GAIN_CFG(ADC0, CHN1, ADC0_1SHUNT_CURR_CH, ADC_GAIN3V6);
		...
		ADC_CHN_GAIN_CFG(ADC0, CHN0, ADC0_CURRETN_A_CHANNEL, ADC_GAIN3V6);
		ADC_CHN_GAIN_CFG(ADC0, CHN1, ADC0_CURRETN_B_CHANNEL, ADC_GAIN3V6);
		ADC_CHN_GAIN_CFG(ADC0, CHN2, ADC0_CURRETN_C_CHANNEL, ADC_GAIN3V6);
		ADC_CHN_GAIN_CFG(ADC0, CHN3, M0_ADC_BUS_CURR_CH, ADC_GAIN3V6);	
	#endif
...
static void CurrentOffsetReadPWM1(STR_PubDatHDMD* tS_pHdToMd,u16 t_nuCalPeriod)
{
	...
	EPWM1_OutPut(DISABLE); //对于非MOS内阻采样，可使能也可不使能
	...
	//单电阻Offset
	#if (EPWM0_CURRENT_SAMPLE_TYPE == CURRENT_SAMPLE_1SHUNT)
		//ADC_1Shunt_NormalModeCFG();
		ADC_CHN_GAIN_CFG(ADC1, CHN0, ADC1_1SHUNT_CURR_CH, ADC_GAIN3V6);
		ADC_CHN_GAIN_CFG(ADC1, CHN1, ADC1_1SHUNT_CURR_CH, ADC_GAIN3V6);
		ADC_CHN_GAIN_CFG(ADC1, CHN2, ADC_BUS_VOL_CHANNEL, ADC_GAIN3V6);
		ADC_CHN_GAIN_CFG(ADC1, CHN3, M0_ADC_BUS_CURR_CH, ADC_GAIN3V6);
	#elif (EPWM0_CURRENT_SAMPLE_TYPE == CURRENT_SAMPLE_2SHUNT)
		ADC_CHN_GAIN_CFG(ADC1, CHN0, ADC1_CURRETN_A_CHANNEL, ADC_GAIN3V6);
		ADC_CHN_GAIN_CFG(ADC1, CHN1, ADC1_CURRETN_B_CHANNEL, ADC_GAIN3V6);
		ADC_CHN_GAIN_CFG(ADC1, CHN2, ADC_BUS_VOL_CHANNEL, ADC_GAIN3V6);
		ADC_CHN_GAIN_CFG(ADC1, CHN3, M0_ADC_BUS_CURR_CH, ADC_GAIN3V6);
	#elif  (EPWM0_CURRENT_SAMPLE_TYPE == CURRENT_SAMPLE_3SHUNT)
		...
		ADC_CHN_GAIN_CFG(ADC1, CHN0, ADC1_CURRETN_A_CHANNEL, ADC_GAIN3V6);
		ADC_CHN_GAIN_CFG(ADC1, CHN1, ADC1_CURRETN_B_CHANNEL, ADC_GAIN3V6);
		ADC_CHN_GAIN_CFG(ADC1, CHN2, ADC1_CURRETN_C_CHANNEL, ADC_GAIN3V6);
		ADC_CHN_GAIN_CFG(ADC1, CHN3, M0_ADC_BUS_CURR_CH, ADC_GAIN3V6);	
	#endif
	...
	{
		/* Clear the ADC0 JEOC pending flag */
		ADC1_SWT = 0x00005AA5;   //软件触发 内部需要区分
