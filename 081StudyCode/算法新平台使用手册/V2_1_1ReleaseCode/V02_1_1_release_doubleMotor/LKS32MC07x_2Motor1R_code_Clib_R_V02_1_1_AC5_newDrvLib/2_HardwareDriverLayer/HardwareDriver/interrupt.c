...
void AdcEocIsr(void (*pAdcEocHandle)(void))
{
   (*pAdcEocHandle)();
}
...
#if 0//(RTT_FUNCTION == FUNCTION_ON)

	Rttstru.data0 = getElectSpdEst(0);
	Rttstru.data1 = DebugT1;//getElectAngleEst(0);
	Rttstru.data2 = getElectAngle(0);;
...
#if ((EPWM1_CURRENT_SAMPLE_TYPE == CURRENT_SAMPLE_2SHUNT)||(EPWM1_CURRENT_SAMPLE_TYPE == CURRENT_SAMPLE_3SHUNT)||(EPWM1_CURRENT_SAMPLE_TYPE == CURRENT_SAMPLE_MOSFET))
