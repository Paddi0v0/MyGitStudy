...
#define U_RATED_CURRENT                (7.07)              /* 单位:A, 电机额定工作电流，相电流最大值 */
#define U_MAX_FREQ                     (6666.6)            /* 单位:Hz,  电机最高运行转速 */

/* ------------------------------Motor Parameter------------------------------ */
#define U_MOTOR_PP                     (2.0)              /* 电机极对数 */
#define U_MOTOR_RS                     (0.150)         /* 单位: Ω 电机相电阻 */
#define U_MOTOR_LD                     (50.0)          /* 单位: uH 电机d轴电感 */ // 100uh  150uh
#define U_MOTOR_LQ                     (100.0)          /* 单位: uH 电机q轴电感 */
...
#define U_START_CUR_SET_F              (1.3)              /* 单位: A 第一段定位电流 */
#define U_START_CUR_SET_S              (2.6)              /* 单位: A 第二段定位电流 */
#define DC_HOLDTIME_TIME_LENTH         (150)               /* 单位: ms 第一段定位时间 */
#define DC_HOLDTIME_TIME_LENTH_STAGE1  (150)               /* 单位: ms 第二段定位时间 */
...
#define OPEN2CLOSE_RUN_CURRENT_RAMP    (0.06)             /* 开环闭环切换过渡内，D,Q轴电流变化斜率。单位：A/ms */
...
/*----------------------------------电流环参数---------------------------------*/
#define IQ_SET                         (0.1)              /* 单位：A IqRef，Iq给定值 */
