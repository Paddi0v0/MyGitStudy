...
{       /*设置P0.0高电平唤醒，此时P0.0为低电平*/                                      /*设置P0.0低电平唤醒，此时P0.0为高电平*/
		if(((WAKE_EN == WAKE_PO) && (!GPIO_ReadInputDataBit(GPIO0, GPIO_Pin_0))) || ((WAKE_EN != WAKE_PO) && GPIO_ReadInputDataBit(GPIO0, GPIO_Pin_0))) //判断不是IO唤醒
		{																																				 //不是IO唤醒，是Utimer唤醒
			Utimer_flag = 1;	
		}
		Awaken_Flag = 1;
