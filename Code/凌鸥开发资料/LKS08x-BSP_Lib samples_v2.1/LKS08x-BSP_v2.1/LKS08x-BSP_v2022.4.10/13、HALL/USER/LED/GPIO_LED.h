...
#define Invers_LED1    Invers_GPIO(GPIO0 , GPIO_Pin_6)//LED1电平反转
#define Invers_LED2    Invers_GPIO(GPIO0 , GPIO_Pin_7)
#define Invers_LED3    Invers_GPIO(GPIO0 , GPIO_Pin_3)
