...
void UART_init(void)
{
    ...
    UART_InitStruct.IRQEna = UART_IRQEna_TX_DMA_RE;  /* 发送完成DMA请求使能 */
...
/*******************************************************************************
 ...
 2021/9/1      V1.0             HMG                创建
 *******************************************************************************/
volatile u8 DMA_TX[10] = {0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x10};
void DMA_init(void)
{
    ...
    DMA_InitStruct.DMA_CMAR = (u32)DMA_TX;            /* DMA 通道 x 内存地址 */
