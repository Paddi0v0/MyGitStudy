...
typedef struct
{
    ...
    uint8_t IO0_PPE;                 /**<  IO0推挽模式使能：1使能，0关闭 */
		...
		uint8_t TMR0_RE1;                /**< MCPWM_CNT01 计数到MCPWM0_TMR0   事件 DMA请求1 使能：1使能，0关闭 */
		...
		uint8_t TMR0_RE0;                /**< MCPWM_CNT01 计数到MCPWM0_TMR0   事件 DMA请求0 使能：1使能，0关闭 */
...
#define MCPWM0_TH00_AUPDATE  BIT0  /**< MCPWM0_TH00 自动加载使能 */
#define MCPWM0_TH01_AUPDATE  BIT1  /**< MCPWM0_TH01 自动加载使能 */ 
#define MCPWM0_TH10_AUPDATE  BIT2  /**< MCPWM0_TH10 自动加载使能 */
#define MCPWM0_TH11_AUPDATE  BIT3  /**< MCPWM0_TH11 自动加载使能 */
#define MCPWM0_TH20_AUPDATE  BIT4  /**< MCPWM0_TH20 自动加载使能 */
#define MCPWM0_TH21_AUPDATE  BIT5  /**< MCPWM0_TH21 自动加载使能 */
#define MCPWM0_TMR0_AUPDATE  BIT8  /**< MCPWM0_TMR0 自动加载使能 */
...
#define MCPWM0_TH30_AUPDATE  BIT16  /**< MCPWM0_TH00 自动加载使能 */
#define MCPWM0_TH31_AUPDATE  BIT17  /**< MCPWM0_TH01 自动加载使能 */ 
#define MCPWM0_TH40_AUPDATE  BIT18  /**< MCPWM0_TH10 自动加载使能 */
#define MCPWM0_TH41_AUPDATE  BIT19  /**< MCPWM0_TH11 自动加载使能 */
#define MCPWM0_TH50_AUPDATE  BIT20  /**< MCPWM0_TH20 自动加载使能 */
#define MCPWM0_TH51_AUPDATE  BIT20  /**< MCPWM0_TH21 自动加载使能 */
#define MCPWM0_TMR2_AUPDATE  BIT24  /**< MCPWM0_TMR0 自动加载使能 */
...
#define MCPWM0CNT0_TH00_IRQ_IF     BIT2  /**< 计数器0计数值回到MCPWM0_TH00中断标志位 */
#define MCPWM0CNT0_TH01_IRQ_IF     BIT3  /**< 计数器0计数值回到MCPWM0_TH01中断标志位 */
#define MCPWM0CNT0_TH10_IRQ_IF     BIT4  /**< 计数器0计数值回到MCPWM0_TH10中断标志位 */
#define MCPWM0CNT0_TH11_IRQ_IF     BIT5  /**< 计数器0计数值回到MCPWM0_TH11中断标志位 */
#define MCPWM0CNT0_TH20_IRQ_IF     BIT6  /**< 计数器0计数值回到MCPWM0_TH20中断标志位 */
#define MCPWM0CNT0_TH21_IRQ_IF     BIT7  /**< 计数器0计数值回到MCPWM0_TH21中断标志位 */

#define MCPWM0CNT0_TMR0_IRQ_IF     BIT10  /**< 计数器0计数值回到MCPWM0_TMR0中断标志位 */
...
#define MCPWM0CNT1_TH30_IRQ_IF     BIT2  /**< 计数器0计数值回到MCPWM0_TH00中断标志位 */
#define MCPWM0CNT1_TH31_IRQ_IF     BIT3  /**< 计数器0计数值回到MCPWM0_TH01中断标志位 */
#define MCPWM0CNT1_TH40_IRQ_IF     BIT4  /**< 计数器0计数值回到MCPWM0_TH10中断标志位 */
#define MCPWM0CNT1_TH41_IRQ_IF     BIT5  /**< 计数器0计数值回到MCPWM0_TH11中断标志位 */
#define MCPWM0CNT1_TH50_IRQ_IF     BIT6  /**< 计数器0计数值回到MCPWM0_TH20中断标志位 */
#define MCPWM0CNT1_TH51_IRQ_IF     BIT7  /**< 计数器0计数值回到MCPWM0_TH21中断标志位 */
