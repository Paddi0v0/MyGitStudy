 ...
 *                     <tr><th> MCPWM0CNT0_TH00_IRQ_IF     <td>BIT2  <td> 计数器0计数值回到MCPWM0_TH00中断标志位 
 *                     <tr><th> MCPWM0CNT0_TH01_IRQ_IF     <td>BIT3  <td> 计数器0计数值回到MCPWM0_TH01中断标志位 
 *                     <tr><th> MCPWM0CNT0_TH10_IRQ_IF     <td>BIT4  <td> 计数器0计数值回到MCPWM0_TH10中断标志位 
 *                     <tr><th> MCPWM0CNT0_TH11_IRQ_IF     <td>BIT5  <td> 计数器0计数值回到MCPWM0_TH11中断标志位 
 *                     <tr><th> MCPWM0CNT0_TH20_IRQ_IF     <td>BIT6  <td> 计数器0计数值回到MCPWM0_TH20中断标志位 
 *                     <tr><th> MCPWM0CNT0_TH21_IRQ_IF     <td>BIT7  <td> 计数器0计数值回到MCPWM0_TH21中断标志位 
 *                     <tr><th> MCPWM0CNT0_TMR0_IRQ_IF     <td>BIT10  <td> 计数器0计数值回到MCPWM0_TMR0中断标志位 
