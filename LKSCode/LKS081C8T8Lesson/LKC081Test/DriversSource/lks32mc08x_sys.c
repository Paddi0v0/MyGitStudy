...
void SYS_FallSleep(void)
{
    ...
    NVIC_DisableIRQ(TIMER2_IRQn);   /*关闭TIMER2中断*/
    NVIC_DisableIRQ(TIMER3_IRQn);   /*关闭TIMER3中断*/
    NVIC_DisableIRQ(ENCODER0_IRQn); /*关闭ENCODER0_IRQn中断*/
    NVIC_DisableIRQ(ENCODER1_IRQn); /*关闭ENCODER1_IRQn中断*/
    NVIC_DisableIRQ(I2C0_IRQn);     /*关闭I2C0中断*/
    NVIC_DisableIRQ(SPI0_IRQn);     /*关闭SPI0中断*/
    ...
    NVIC_DisableIRQ(DSP_IRQn);      /*关闭DSP中断*/
    NVIC_DisableIRQ(CMP_IRQn);      /*关闭CMP中断*/
    NVIC_DisableIRQ(ADC0_IRQn);     /*关闭ADC0中断*/
    NVIC_DisableIRQ(MCPWM_IRQn);    /*关闭MCPWM中断*/
    NVIC_DisableIRQ(DMA_IRQn);      /*关闭DMA中断*/
    NVIC_DisableIRQ(CAN_IRQn);      /*关闭CAN中断*/
    NVIC_DisableIRQ(SIF_IRQn);      /*关闭SIF中断*/
    NVIC_DisableIRQ(PWRDN_IRQn);    /*关闭PWRDN中断*/
...
void Switch2PLL(void)
{
    ...
    NVIC_ClearPendingIRQ(PWRDN_IRQn);               /* 清除电源检测中断标志 */
